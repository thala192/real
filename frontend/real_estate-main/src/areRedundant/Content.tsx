        ...
        <div className={styles.aboutUsParent}>
          ...
          <div className={styles.welcomeToOurContainer}>
            <span className={styles.welcomeToOurContainer1}>
              ...
              >{`With a user-friendly interface and a commitment to excellent service , we try to simplify your real-estate journey. `}</p>
            </span>
          </div>
        </div>
        <div className={styles.aboutIntro}>
          <div className={styles.visionMissionContent}>
            <div className={styles.visionHeader}>
              ...
              >{`Our vision is to be the leading platform,recognized for innovation,trust and customer satisfaction.We envision a world where finding and securing the perfect property is effortless, thanks to cutting-edge technology and unparalleled service     `}</div>
            </div>
            <div className={styles.visionHeader1}>
              ...
              <div className={styles.ourMissionIsToRevolutionizWrapper}>
                ...
                >{`Our mission is to revolutionize the real-estate experience by providing a comprehensive,reliable and easy-to-use platform.We aim to empower our users with the best tools and resources to make informed decisions,ensuring a smooth and successful property transaction for everyone. `}</div>
              </div>
            </div>
          </div>
