...
import styles from "./StaffVerifyProperties.module.css";
...
interface StaffVerifyPropertiesProps {
  properties: Property[];
  loading: boolean;
  error: string | null;
...
const StaffVerifyProperties: React.FC<StaffVerifyPropertiesProps> = ({
  properties,
  loading,
  error,
